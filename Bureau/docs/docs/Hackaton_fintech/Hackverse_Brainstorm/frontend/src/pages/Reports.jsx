...
import { getCashflowReport, api } from '../services/api';
        ...
        <table>
          <thead>
            <tr>
              ...
              <th style={{padding: '12px', textAlign: 'left'}}>Entrées</th>
              <th style={{padding: '12px', textAlign: 'left'}}>Sorties</th>
              <th style={{padding: '12px', textAlign: 'left'}}>Solde Mensuel</th>
            </tr>
          </thead>
          <tbody>
            {data.map(m => (
